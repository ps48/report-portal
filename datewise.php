							...
							if($_SESSION['user-level']==2)
								{
									echo "<div>Reports you have already submitted</div>";
										...
										if($result)
										{
											...
											{
												$dates= $row['timestamp'];	
												echo "<a href=\"./showreport.php?user=".$_SESSION['user-id']."&time=".$dates." \" target=\"_blank\">". $dates."</a> ";
											}
								...
								else
								{
									if(isset($_GET['regno'])&&(($_SESSION['user-level']==1)||($_SESSION['user-level']==0)))
									{
										...
										if($result)
										{
											...
											{
												$dates= $row['timestamp'];	
												echo "<a href=\"./showreport.php?user=".$_GET['regno']."&time=".$dates." \" target=\"_blank\">". $dates."</a> ";
											}
										...
										{	
											...
											if($result)
											{
												...
												{	
													...
													echo "<a href=\"./namewise.php?time=".$dates." \" >". $dates."</a> ";
												}
										...
										{	if(($_SESSION['user-level']==1)||($_SESSION['user-level']==0))
											{
												...
												if($result)
												{
													...
													{	
														...
														echo "<a href=\"./showreport.php?user=".$user."&time=".$dates." \" target=\"_blank\">". $times."</a>";
													}
