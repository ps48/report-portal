							...
							if(!isset($_GET['time']))  
								{
									...
									if($result)
									{
										...
										{
											//$dates= $row['timestamp'];	
											//echo "<a href=\"./showreport.php?user=".$_SESSION['user-id']."&time=".$dates." \" target=\"_blank\">". $dates."</a> <br>";


											$name=$row['name'];
											$regno=$row['regno'];
											echo "<a href=\"./datewise.php?regno=".$regno."&name=".$name." \" >".$name ." </a>";
										}
									...
									$result=mysql_query($query,$con);
										...
										{	
											...
											{	
												...
												echo "<a href=\"./datewise.php?username=".$username."&time=".$_GET['time']." \" >".$username."</a> ";
